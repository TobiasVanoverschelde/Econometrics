...
on the excluded instruments in the first stage, compared to the
\citet{StockYogo2005} 10\%-maximum-size critical value of 19.93 (two
IVs, one endogenous regressor). Values below the threshold indicate
weak instruments and invalid conventional standard errors.
